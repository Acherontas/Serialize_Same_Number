...
//
acherontas@rpifive:~/codeblocks/seira_praxeon_arm64/bin/Debug $ ./seira_praxeon_arm64 2785 /+*-
...
using / 0 2785 --> current rst / ::== 1

using + 1 1 --> current rst + ::== 2786

using * 2786 2786 --> current rst * ::== 7759010

using - 7759010 7759010 --> current rst - ::== 7756225
